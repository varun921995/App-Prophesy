...
# includes method for  traininig models used for prediction of rating and installation.
...
def trainModelRating(df_train):
    ...
    with open("temp/rating.txt", "a") as myfile:
        ...
        myfile.write(
            "RMSE:" + str(np.round(sqrt(mean_squared_error(y_test, predicted)), 2)))

    return xgbModel

# training model for installations
